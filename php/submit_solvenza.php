...
try {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO solicitudes_solvenza (nombre, email, telefono, ingresos) 
                VALUES (?, ?, ?, ?)";
        ...
        $stmt->bind_param("sssd", $nombre, $email, $telefono, $ingresos);
        ...
        // Éxito
        echo "<script>
                alert('¡Solicitud de Crédito Solvenza enviada con éxito!');
    ...
    echo "<script>
            ...
            window.location.href='../credito-solvenza.html';
          </script>";
} finally {
    if (isset($stmt)) {
        $stmt->close();
